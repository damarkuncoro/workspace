...
# Generator: Views::Metronic::NewGenerator
# Tujuan: Membuat view `new` untuk resource nested (misal issues/employees)
  ...
  module Metronic
      class NewGenerator < Rails::Generators::Base
        ...
        def create_new_views
          ...
          template 'new.html.erb.tt', File.join(dest_dir, 'new.html.erb')
